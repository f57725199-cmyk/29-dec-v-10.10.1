                  ...
                  <div className="bg-gradient-to-r from-pink-50 to-rose-50 p-4 rounded-2xl border border-pink-100 shadow-sm mt-4">
                      ...
                      <button 
                          onClick={() => {
                              ...
                              const subName = prompt("Enter Subject Name (e.g. Math, Physics):");
                              if (!subName) return;
                              const chName = prompt("Enter Chapter Name:");
                              if (!chName) return;
                              const type = prompt("What do you need? (PDF / MCQ / VIDEO)");
                              if (!type) return;
                              ...
                              const request = {
                                  ...
                                  userId: user.id,
                                  userName: user.name,
                                  details: `${cls} ${board} - ${subName} - ${chName} - ${type.toUpperCase()}`,
